...
values (100, 'ana@email.com.br', '$2a$12$QOuUQJv2ZYL05unDzYasb.wIb19e2c8CvFCmoZ.qClLvrFAScnNbe', 'ROLE_ADMIN');
insert into USUARIOS (id, username, password, role)
values (101, 'bia@email.com.br', '$2a$12$QOuUQJv2ZYL05unDzYasb.wIb19e2c8CvFCmoZ.qClLvrFAScnNbe', 'ROLE_CLIENTE');
insert into USUARIOS (id, username, password, role)
values (102, 'bob@email.com.br', '$2a$12$QOuUQJv2ZYL05unDzYasb.wIb19e2c8CvFCmoZ.qClLvrFAScnNbe', 'ROLE_CLIENTE');
